            ...
            match if_token_valid_result {
                    ...
                    match e {
                        ...
                        _ => {
                            methods::standard_replies::internal_server_error_response(
                                String::from("agreement/lock: Token verification unexpected error"),
                            )
                        }
                    }
                }
                Ok(valid_token) => {
                        ...
                        Ok(bool) => {
                            if !bool {
                                return methods::standard_replies::internal_server_error_response(
                                    String::from("agreement/lock: Token extension failed (returned false)"),
                                );
                            }
                        }
                        Err(_) => {
                            return methods::standard_replies::internal_server_error_response(
                                String::from("agreement/lock: Token extension error"),
                            );
                        }
                    }
                    ...
                    let user_in_request = match user_in_request {
                        ...
                        Err(_) => {
                            return methods::standard_replies::internal_server_error_response(
                                String::from("agreement/lock: Database error loading renter"),
                            );
                        }
                    };
                    ...
                    let agreement = match agreement {
                        ...
                        Err(e) => {
                            return match e {
                                ...
                                _ => {
                                    methods::standard_replies::internal_server_error_response(
                                        String::from("agreement/lock: Database error loading agreement"),
                                    )
                                }
                            };
                        }
                    ...
                    let Ok((vehicle_remote_mgmt, mgmt_id)) = result else {
                        return methods::standard_replies::internal_server_error_response(
                            String::from("agreement/lock: Database error loading vehicle remote mgmt info"),
                        )
                    };
