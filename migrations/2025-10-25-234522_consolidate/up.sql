...
(
    ...
    mileage_rate_overwrite      double precision,
    mileage_package_overwrite   double precision,
    utilization_factor          double precision            default 1.00                not null,
...
(
    ...
    constraint charges_name_time_with_transponder_uk unique (name, time, transponder_company_id, vehicle_identifier),
