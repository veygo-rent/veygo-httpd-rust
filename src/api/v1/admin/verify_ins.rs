                    ...
                    match result {
                        ...
                        Ok(is_renewed) => {
                            if !is_renewed {
                                ...
                                match body {
                                    ...
                                    helper_model::VerifyInsuranceRequest::Declined { reason, .. } => {
                                        ...
                                        tokio::spawn(async move {
                                            ...
                                            let email_content = helper_model::DocumentRejectionTemplate { document_name: "Insurance Card", reason: &reason };
                                            let _email_result = integration::mailgun_veygo::send_email(
                                                None,
                                                vec![email],
                                                "Your Insurance Card is Declined",
                                ...
                                let link = helper_model::FileLink{ file_link: link, file_name: doc_path_unsigned };
