...
create type verification_type_enum as enum ('email', 'phone', 'reset_password');
...
(
    ...
    corresponding_key_for_vehicle_id         text               not null,
    corresponding_key_for_transaction_name   text               not null,
    custom_prefix_for_transaction_name       text               not null,
    corresponding_key_for_transaction_time   text               not null,
    corresponding_key_for_transaction_amount text               not null,
...
(
    ...
    drivers_license_image_secondary text,
    drivers_license_expiration      date,
    insurance_id_image              text,
    ...
    plan_total_availability         numeric(4, 2)               default 0.0                         not null,
    insurance_collision_valid       boolean                     default false                       not null,
...
(
    ...
    msrp_factor                   numeric(5, 4)                                     not null,
...
create index agreements_status_idx
...
(
    ...
    admin_fee         numeric(8, 4),
    tow_charge        numeric(8, 4),
    citation          numeric(8, 4),
    ...
    constraint claims_citation_range check (citation >= 0.0)
);
...
(
    ...
    depreciation                       numeric(10, 4),
    lost_of_use                        numeric(8, 4),
...
(
    ...
    plan_renewal_day                date                                                not null,
