                ...
                Ok(valid_token) => {
                    ...
                    match vehicle.remote_mgmt {
                        model::RemoteMgmtType::Tesla => {
                            ...
                            let result = integration::tesla_veygo::tesla_make_request(Method::POST, &cmd_path, None).await;
                    ...
                    if vehicle.remote_mgmt == model::RemoteMgmtType::Tesla {
                        ...
                        let result = integration::tesla_veygo::tesla_make_request(Method::GET, &charge_history_path, None).await;
